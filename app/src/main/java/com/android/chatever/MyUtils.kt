...
object MyUtils {
    ...
    fun saveStringValue(context: Context, key: String, value: String) {
        val sharedPreferences: SharedPreferences =
            context.getSharedPreferences("MySharedPrefchatever", MODE_PRIVATE)
    ...
    fun showProgress(context: Context) {
        if (dialog == null) {
            ...
            dialog!!.setCanceledOnTouchOutside(false)
                var imgProgress=    dialog!!.findViewById<ImageView>(R.id.imageProgress)
                val clk_rotate = AnimationUtils.loadAnimation(
                    context,
                    R.anim.flip_anim
                )
                imgProgress.animation=clk_rotate
