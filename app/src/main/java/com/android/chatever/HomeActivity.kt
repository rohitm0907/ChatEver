...
import com.android.chatever.adapters.HomeTabAdapter
import com.android.chatever.databinding.ActivityHomeBinding
import java.util.*
        ...
        when (item.itemId) {
            R.id.txtShare -> {
                val dynamicLink = Firebase.dynamicLinks.dynamicLink {
                    link = Uri.parse("https://chatever.com/?phone=${MyUtils.getStringValue(this@HomeActivity, MyConstants.USER_PHONE)}")
...
//                        phone ="919815187258"
            ...
            R.id.txtContactUs->{
                ...
                val recipients = arrayOf("android.m0907@gmail.com")
                intent.putExtra(Intent.EXTRA_EMAIL, recipients)
                intent.putExtra(Intent.EXTRA_SUBJECT, "ChatEver Review")
                intent.type = "text/html"
                intent.setPackage("com.google.android.gm")
                startActivity(Intent.createChooser(intent, "Send mail"))
            //                try {
//                    val email = "android.m0907@gmail.com"
