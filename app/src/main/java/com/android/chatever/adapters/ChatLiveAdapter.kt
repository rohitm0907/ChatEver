package com.android.chatever.adapters
...
import com.android.chatever.Models.LiveChatModel
...
//            showAnimation(holder.rlView,R.anim.right_to_left);
        ...
        if (chatsList.get(position).messageType.equals("text") || chatsList.get(position).deleteStatus.equals("1")) {
...
Log.d("position",position.toString())
        ...
        holder.txtMessage.setOnLongClickListener{
            if (chatsList.get(position).deleteStatus.equals("0") && chatsList.get(position).sender.equals(MyUtils.getStringValue(context, MyConstants.USER_PHONE))) {
...
//                notifyItemChanged(previousPlay)
    ...
    private fun showPopupDialog(position: Int, view: View) {
        ...
        popup.getMenuInflater().inflate(com.android.chatever.R.menu.message_menu, popup.menu)
