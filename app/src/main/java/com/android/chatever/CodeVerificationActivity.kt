...
import com.android.chatever.databinding.ActivityCodeVerificationBinding
...
class CodeVerificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enteredPhone="+"+intent.getStringExtra(MyConstants.PHONE_NUMBER)
        binding.otpView.setOtpCompletionListener(object : OnOtpCompletionListener {
            override fun onOtpCompleted(otp: String) {
                // do Stuff
                isOtpEnter=true
                if(enteredPhone.equals("+919815187258") && otp.equals("981518")){
        ...
        if(!enteredPhone.equals("+919815187258")) {
