package com.rohit.chatever.Firebase
...
import com.rohit.chatever.HomeActivity
...
//         this shows a number in the notification dots
        ...
        if (message.equals("You have been block")) {
            if(com.rohit.chatever.ChatLiveActivity.getInstance()!=null){
                com.rohit.chatever.ChatLiveActivity!!.getInstance()!!.onBlock(title!!);
            }
        }
    ...
    fun Note() {
        ...
        notification.setSound( Uri.parse("android.resource://com.rohit.chatever/raw/rain_drop"))
